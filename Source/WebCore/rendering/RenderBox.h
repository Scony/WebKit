...
private:
    ...
    void computeAnchorCenteredPosition(LogicalExtentComputedValues&, RenderBoxModelObject* defaultAnchorBox, Length logicalLeftLength, Length logicalRightLength, LayoutUnit containerLogicalWidth, bool computeHorizontally) const;
